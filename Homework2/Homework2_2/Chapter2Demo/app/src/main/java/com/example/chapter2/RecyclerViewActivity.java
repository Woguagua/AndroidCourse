...
//    private MyAdapter2 mAdapter2;
    ...
    String viewcount = "ViewCount" + CountView(recyclerView);
...
//        recyclerView.setItemAnimator(animator);
    ...
    protected void onStart() {
        ...
        viewcount = "ViewCount" + CountView(recyclerView);
        Log.i(TAG, viewcount);
    }
...
//                break;
    ...
    public void onItemLongCLick(int position, TestData data) {
        Toast.makeText(RecyclerViewActivity.this, viewcount, Toast.LENGTH_SHORT).show();
//        mAdapter.removeData(position);
    }

    public int CountView(android.view.View parent){
        int count = 0;
        if (parent == null)   return count;
            ...
            for (int i = 0; i < ((android.view.ViewGroup)parent).getChildCount(); i++){
                android.view.View child = ((android.view.ViewGroup)parent).getChildAt(i);
                if (child instanceof android.view.ViewGroup)    count += CountView(child);
                else count++;
            }
        }
        return count;
